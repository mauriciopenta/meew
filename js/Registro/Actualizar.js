...
var Actualizar = function(){
    ...
    $("input[type=radio][name='UsuarioFormUpdate[plan]']").change(function() {
        $("#error_plan").text("");
        $.ajax({
            'url': 'validate_plan?code='+this.value,
            'datatype': 'json',
            'type': 'GET',
            'success': function(data){

                $("#error_plan").text(data.response);
            },
...
$(document).ready(function() {
    window.Actualizar=new Actualizar();
});