...
class TemaSoporteController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('TemaSoporte');
	...
	{
		$model=new TemaSoporte('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TemaSoporte']))
			$model->attributes=$_GET['TemaSoporte'];
	 ...
	 * @return TemaSoporte the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TemaSoporte::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TemaSoporte $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tema-soporte-form')
		{
